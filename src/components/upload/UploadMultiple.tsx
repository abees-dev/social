...
type UploadMultipleType = IUploadMultiple & DropzoneOptions;

// eslint-disable-next-line react/display-name
const UploadMultiple = forwardRef(({ files, sx, singlePreview, ...other }: UploadMultipleType, ref) => {
